 ...
 * Enchantments in an offer must be entries obtained from Endstone's Enchantment registry; if any other Enchantment
 * implementation is used, every change made to the offers is discarded and the table keeps the offers it computed.
 */
...
public:
     ...
     *
     * @param enchants the enchantments and levels applied by the offer; must not be empty, and every entry must be a
     * non-null enchantment with a level greater than 0
     * @param cost the minimum player level required to select the offer; must be greater than 0
     */
     ...
     *
     * @param enchants the enchantments and their levels; must not be empty, and every entry must be a non-null
     * enchantment with a level greater than 0
     */
     ...
     *
     * @param cost the minimum required player level; must be greater than 0
     */
