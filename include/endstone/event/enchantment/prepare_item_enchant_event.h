 ...
 *
 * Each offer contains every enchantment that Bedrock applies when its corresponding button is selected.
 *
 ...
 * @note Bedrock publishes all three offers or none at all, so setting any offer to std::nullopt removes all of them.
 */
