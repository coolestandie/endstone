...
void init_event(py::module_ &m, py::class_<Event, PyEvent> &event)
{
    ...
    enchanting offers.
        ...
        .def_property(
            "offers", py::overload_cast<>(&PrepareItemEnchantEvent::getOffers, py::const_),
            [](PrepareItemEnchantEvent &self, PrepareItemEnchantEvent::Offers value) {
                self.getOffers() = std::move(value);
            },
